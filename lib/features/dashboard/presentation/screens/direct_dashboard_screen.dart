...
import 'package:etoken/features/profile/presentation/screens/profile_screen.dart';
import 'package:etoken/features/transactions/presentation/screens/transactions_screen.dart';
...
class DirectDashboardScreen extends StatefulWidget {
  ...
  const DirectDashboardScreen({super.key, this.title = "Home"});
                    ...
                    icon: ClipOval(
                      child:
                          image != null
                              ...
                              : Image.asset(
                                "lib/core/ui/icons/img_happy_face.png",
                                width: 32,
                                height: 32,
                                fit: BoxFit.cover,
                              ),
                    ...
                    child: _QuickActionsListItem(
                      ...
                      onPressed:
                          () => Navigator.of(context).push(
                            MaterialPageRoute(
                              builder:
                                  (buildContext) => TransactionsScreen(),
                            ),
                          ),
                    ),
                  ),
